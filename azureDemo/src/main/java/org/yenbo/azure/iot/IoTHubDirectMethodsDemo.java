...
public class IoTHubDirectMethodsDemo {
	...
	public static void main(String[] args) {
		...
		String payload = "{\"message\": \"DM hello from yenbo " + Instant.now() + "\"}";
...
//					RESPONSE_TIMEOUT_SECS, CONNECT_TIMEOUT_SECS, payload);
			
			MethodResult result = methodClient.invoke(edgeDeviceId, edgeModuleId,
					"whoCares", RESPONSE_TIMEOUT_SECS, CONNECT_TIMEOUT_SECS, payload);
